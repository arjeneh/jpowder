...
public class JPowder extends JApplet implements ListSelectionListener, java.awt.dnd.DropTargetListener{
    //Initializes the applet MainApplet
    
    private URL source;//url of the file.
    public Vector<File> fileToReadVector = new Vector<File>();//all actual xye files.
    public Vector data;
    ...
    public void init() {
        ...
        dt = new java.awt.dnd.DropTarget(file_lst, this);
    ...
    private void deleteFile_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteFile_btnActionPerformed
        ...
        if (file_lst.getSelectedIndex() == -1) {
            javax.swing.JOptionPane.showMessageDialog(JPowder.this, "To delete, please select a file first.");
            return;
        }
        
        //if the list is empty then do nothing
        if (listModel.getSize() <= 0) {
            javax.swing.JOptionPane.showMessageDialog(JPowder.this, "Please add a file first.");
            return;
        }
