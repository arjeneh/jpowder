...
public class XYChartPanel extends JPanel implements Cloneable{
     ...
     */
    public XYChartPanel(Vector theData, String theFileTitle) {
        this.data = theData;
        ...
        this.chartPanel.addChartMouseListener(new ChartMouseObserver());
    ...
    public XYDataset createDataset(String name) {
        ...
        for (int rowIndex = 0; rowIndex < data.size(); rowIndex++) {
            ...
            for (int colIndex = 0; colIndex < row.size(); colIndex++){
                ...
                series1.add(x, y);//series2.add(t, u);
            }//end for 2
        }//end for 1
    ...
    protected Object clone() throws CloneNotSupportedException {
        ...
        XYChartPanel clone = (XYChartPanel) super.clone();
