 ...
 * @author Arjeneh
 */
public class ZoomAndPan extends javax.swing.JPanel implements InfoPanel, AdjustmentListener, ChangeListener,
        ChartChangeListener {
...
//    domainAxis.setRange(lowerBound + x, upperBound + x);
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        moveButt.setFont(new java.awt.Font("Tahoma", 0, 9)); // NOI18N
   ...
   JpowderInternalframe inFocus = JPowder.internalFrameInFocus;
      if (moveButt.isSelected()) {
          inFocus.getXYPlot().setDomainPannable(true);
           inFocus.getXYPlot().setRangePannable(true);
            setPanMode(true);
      }
...
//      getScrollBar();
    ...
    layout.setHorizontalGroup(
      layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
      .addComponent(scrollBar, javax.swing.GroupLayout.DEFAULT_SIZE, 317, Short.MAX_VALUE)
    );
    layout.setVerticalGroup(
      layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
      .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
        .addContainerGap(400, Short.MAX_VALUE)
        .addComponent(scrollBar, javax.swing.GroupLayout.PREFERRED_SIZE, 8, javax.swing.GroupLayout.PREFERRED_SIZE))
    );

     scrollBar.updateUI();
      if(jCheckBoxDomain.isSelected()||jCheckBoxRange.isSelected()){

//        inFocus.getContentPane().add
//                (scrollBar, BorderLayout.SOUTH);
//        inFocus.updateUI();
