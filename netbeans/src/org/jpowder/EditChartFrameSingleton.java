 ...
 */
public class EditChartFrameSingleton extends javax.swing.JFrame {
    
    private static org.jfree.chart.JFreeChart jFreeChart;
    private org.jfree.chart.ChartPanel chartPanel;
    private static EditChartFrameSingleton singletonObject;
    
    /** Creates new form EditChartFrame
     * @param chart JFreeChart Object
     */
    private EditChartFrameSingleton(org.jfree.chart.JFreeChart chart) {
        initComponents();
        jFreeChart = chart;
    ...
    public static synchronized EditChartFrameSingleton getSingletonObject(org.jfree.chart.JFreeChart jFreeChart) {
        if (singletonObject == null){
            singletonObject = new EditChartFrameSingleton(jFreeChart);
        }
