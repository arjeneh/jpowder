...
import org.jpowder.chartTools.PowderChartMouseObserver;
...
//    protected BalloonAnnotation balloonPanel = new BalloonAnnotation();
    ...
    protected void doStuff(String selectedMetaItem) {
        ...
        System.out.println("in " + this.getClass().getName() + "Str of Meta Data Item slected is: " + str);
        ...
        //29/12/2012 add MouseListener will work with JpowderInternalFrame2D not 3D,
        //i dont know why.
        this.jfreeChartPanel.addChartMouseListener(new PowderChartMouseObserver(jfreeChartPanels));
    ...
    protected void doStuff(String selectedMetaItem, HashMap fileNameAndPath) {
        ...
        jfreeChartPanels.add(new JpowderPopupMenu(jfreeChartPanels));
        this.jfreeChartPanel = jfreeChartPanels;
        //29/12/2012 add MouseListener.
        //29/12/2012 add MouseListener will work with JpowderInternalFrame3D,
        //i dont know why.
        this.jfreeChartPanel.addChartMouseListener(new PowderChartMouseObserver(jfreeChartPanels));
        ...
        //this.setResizable(false);//disable this to false to make the JFreeChart not redraw.
        this.setIconifiable(true);
        this.setFrameIcon(new ImageIcon(getClass().getResource("/images/JpowderLogo.png")));
        this.setLocation((int) Jpowder.getDropLocationX(), (int) Jpowder.getDropLocationY());
        this.pack();
    ...
    public void setPowderDataSet(Vector<DataSet> v) {
        this.vectorDatasets = v;
    }

    public void removePowderDataSet() {
        this.vectorDatasets.clear();
    }
