...
public class BalloonFrame extends javax.swing.JFrame implements IMapObserver {
    ...
    public BalloonFrame(PointAnno pn) {
        ...
        initComponents();
        this.commentText.setText(this.pa.getComment());
    ...
    /**
     * Update comment from EditAnnotationFrame.
     *
     * @param comment
     */
    public void setComment(String comment){
        //boolean sucess = false;
        this.pa.setComment(comment);
        this.getCommentText().setText(this.pa.getComment());
        //return true;
    ...
    private void initComponents() {
        ...
        commentText.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        commentText.setLineWrap(true);
        commentText.setRows(5);
        commentText.setText("See how things?");
        commentText.setAutoscrolls(false);
        commentText.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        commentText.setHighlighter(null);
    ...
    private void deleteButActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButActionPerformed
        ...
        //Refactor from Core to Standalone - 29122012
    ...
    private void editButActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButActionPerformed
        // Show the EditAnnotationFrame popup:
         //Refactor from Core to Standalone - 29122012
        EditAnnotationFrame enf = EditAnnotationFrame.getInstance();
        Map support = enf.getAnnoMap();
        //Map
        System.out.println("Edit Found Annotation ID: " + HashMapHelper.getKeyByValue(support, this.pa)
                + "************" + " in class: " + this.getClass().getName());
        enf.showAnnotation(this.pa);
        this.pa.setBallonFrame(this);
    ...
    public void setCommentText(String commentText) {
        this.commentText.setText(commentText);// commentText;
    }
}
