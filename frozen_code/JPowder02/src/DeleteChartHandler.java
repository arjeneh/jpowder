...
public class DeleteChartHandler implements ActionListener {
    ...
    public DeleteChartHandler(MainApplet m){
    ...
    public void actionPerformed(ActionEvent actionEvent) {
        ...
        Object[] chartNames = insertChartNames();//check if no chart, we alert.
...
class DeleteChartDialog extends JFrame   {
    ...
    public DeleteChartDialog(String[] theStrings, MainApplet theMainApplet, Point displayLocation) {
        this.strings = theStrings;
        this.mainApplet = theMainApplet;
        
        final JComboBox petList = new JComboBox(this.strings);
