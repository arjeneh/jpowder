...
public class QuestionSetPanel extends javax.swing.JPanel{
    ...
    public QuestionSetPanel(String q){
        ...
        buttonGroup1.add(rb4);
        rb4.setFont(new java.awt.Font("Courier", 0, 13));
        ...
        buttonGroup1.add(rb5);
        rb5.setFont(new java.awt.Font("Courier", 0, 13));
        rb5.setActionCommand("5");
        rb5.setText("very good");
        rb5.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0));
        rb5.setMargin(new java.awt.Insets(0, 0, 0, 0));
